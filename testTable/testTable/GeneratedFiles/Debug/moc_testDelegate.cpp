...
const QMetaObject testDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_testDelegate.data,
      qt_meta_data_testDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *testDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_testDelegate.stringdata0))
        return static_cast<void*>(const_cast< testDelegate*>(this));
